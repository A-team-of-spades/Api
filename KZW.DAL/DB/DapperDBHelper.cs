...
namespace KZW.DAL.DB
{
    public class DapperDBHelper
    {
        ...
        {
            using (IDbConnection conn = new SqlConnection(locastr))
            {
        ...
        /// <returns></returns>
        public int ExecuteNonQuery(string procName, DynamicParameters parameters = null)
        {
            using (IDbConnection conn = new SqlConnection(locastr))
            {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public List<T> GetList<T>(string sql, object param)
        {
            using (IDbConnection conn = new SqlConnection(locastr))
            {
        ...
        /// <returns></returns>
        public List<T> GetList<T>(string procName, DynamicParameters parameters = null)
        {
            using (IDbConnection conn = new SqlConnection(locastr))
            {
